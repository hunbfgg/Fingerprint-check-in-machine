...
void TIM3_IRQHandler(void)   //定时器3中断服务程序
{
	...
	if (TIM_GetITStatus(TIM3, TIM_IT_Update) != RESET)  //检查TIM3更新中断发生与否
	{
		if(return_time_flag==1)
		{
			...
			Show_Str(10,300,200,16,"管理员模式",16,1); 
			Show_Str(200,300,200,16,"详情",16,1);
		...
		if(t!=calendar.sec)
		{
			...
			{
					case 0:
						LCD_ShowString(30+100,240,200,16,16,"Sunday   ");
						break;
					case 1:
						LCD_ShowString(30+100,240,200,16,16,"Monday   ");
						break;
					case 2:
						LCD_ShowString(30+100,240,200,16,16,"Tuesday  ");
						break;
					case 3:
						LCD_ShowString(30+100,240,200,16,16,"Wednesday");
						break;
					case 4:
						LCD_ShowString(30+100,240,200,16,16,"Thursday ");
						break;
					case 5:
						LCD_ShowString(30+100,240,200,16,16,"Friday   ");
						break;
					case 6:
						LCD_ShowString(30+100,240,200,16,16,"Saturday ");
						break;  
				}
				...
				if(calendar.hour==clock_set [0]&&calendar.min==clock_set[1]&&calendar.sec==50)  //设置的签到时间
				{
					write_to_file();	
					flag4=1;
				}
				
				if(calendar.hour==clock_set [2]&&calendar.min==clock_set[3]&&calendar.sec==50)  //设置的签退时间
				{
					flag5=1;	
				}
				else
				...
				if(calendar.hour>=(clock_set [0]-1)&&flag4!=1)  
				{
					flag3=1;	
				}
				else
